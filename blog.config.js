...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:7c1d570661754c8fbc568e00a01fd70e', // 格式：中文页面ID,en:英文页面ID
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'jiabin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiabin.xyz', // 网站地址
