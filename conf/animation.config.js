...
module.exports = {
  // 鼠标点击烟花特效
  FIREWORKS: process.env.NEXT_PUBLIC_FIREWORKS || falise, // 开关
  ...
  // 鼠标变换特效（新）
  MOUSE_TRANSFORM: process.env.NEXT_PUBLIC_MOUSE_TRANSFORM || false, // 开关 - 现代化的鼠标变换效果，包含多种状态和动画
  
  // 高级鼠标效果
  CURSOR_EFFECTS: process.env.NEXT_PUBLIC_CURSOR_EFFECTS || false, // 开关 - 高级鼠标效果
  CURSOR_EFFECT_TYPE: process.env.NEXT_PUBLIC_CURSOR_EFFECT_TYPE || 'default', // 效果类型: default, glow, elastic, magnetic, morphing, particles, galaxy
  CURSOR_EFFECT_COLOR: process.env.NEXT_PUBLIC_CURSOR_EFFECT_COLOR || '#3b82f6', // 光标颜色
