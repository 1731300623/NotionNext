...
const ExternalPlugin = props => {
  ...
  const MOUSE_TRANSFORM = siteConfig('MOUSE_TRANSFORM', null, NOTION_CONFIG)
  const CURSOR_EFFECTS = siteConfig('CURSOR_EFFECTS', null, NOTION_CONFIG)
...
const MouseTransform = dynamic(() => import('@/components/MouseTransform'), {
  ssr: false
})
